...
public class Main {
     ...
     *     call setView(new View(this))
     *     try
     *         -- Note that when we try to open "gradebook.txt" for reading that GradebookReader()
     *         -- may throw a FileNotFoundException which we catch here.
     *         create a GradbookReader object named gbReader opening "gradebook.txt" for reading
     ...
     *         gradebook.txt for reading. Exiting."
    ...
    private void run(){
        ...
        try{
            ...
            getView().messageBox("Sorry, could not open gradebook.txt for reading. Exiting.");
            System.exit(-1);
        }  
    }
     ...
     * method exit() : void
     *     try
     *         instantiate a GradebookWriter object named gbWriter, opening "gradebook.txt" for
     *         writing
     ...
     *         not open gradebook.txt for writing. Exiting without saving."
